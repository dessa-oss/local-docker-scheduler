...
gpu_pool = {}  # TODO: This is currently thread safe based on the implementation of the peak queue and where it is being used, but NOT thread safe if anyone else touched it directly